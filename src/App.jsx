    ...
    <div className="min-h-screen bg-slate-50 p-4 font-sans text-slate-800">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-start gap-2 p-3 bg-amber-50 text-amber-800 text-xs rounded-lg border border-amber-100">
           ...
           <p>
             <strong>Disclaimer:</strong> This tool uses linear interpolation of <strong>manually coded</strong> points (rounded to nearest 0.5) from the <strong>AAP 2004</strong> graphs. It is a clinical aid, not a medical device. Always verify with official charts.
           </p>
        </div>
